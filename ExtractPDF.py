...
for i in range(2,4):
    ...
    listOfTables = tabula.read_pdf("24AAACG6864F1ZO_0"+str(i)+"2019_GSTR3B.pdf", multiple_tables=True, pages = 'all');
    print("listOfTablesPg1\n",listOfTables[8].values[list(listOfTables[8].values[:,0]).index('Total')])
    year.append(text[20]);
